...
public class C01_Constructor12 {//Class level
    /*
   ...
   // C01_HelloWord obj99 = new C01_HelloWord();// hariçten bir Class'dan p'siz const ile obj create edildi
    ...
    public static void main(String[] args) {//main level
        ...
        C01_Constructor12 obj1 = new C01_Constructor12();// farklı scop'larda aynı isimde obj creta edilebilir.
        //C01_Constructor obj1 = new C01_Constructor();// aynı scop'da aynı isimde obj creta edilemez
        C01_Constructor12 obj2 = new C01_Constructor12();// faistenilen scop'a istenildiğikadar obj create edilebilir
        C01_Constructor12 obj3 = new C01_Constructor12();// farklı scop'larda aynı isimde obj creta edilebilir.
